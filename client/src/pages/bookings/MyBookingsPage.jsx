...
import { Calendar, Clock, MapPin, Trash2, Loader2, Filter } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-[rgb(var(--color-muted))]">
          ...
          <p className="text-sm mt-1">Book a class from any gym's timetable</p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                {booking.status === 'confirmed' && !isPast && (
                  ...
                  >
                    {cancelling === booking._id ? <Loader2 className="w-3 h-3 animate-spin" /> : <><Trash2 className="w-3 h-3" /> Cancel</>}
                  </button>
                )}
              </div>
            );
